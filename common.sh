...
Success(){
echo -e  "[\e[32mSUCCESS\e[0m][\e[1;35m ${Component}\e[0m] [\e[1;36m$(date "+%F %T")\e[0m] \e[1;32m $1  success\e[0m"
}
Fail(){
echo -e  "[\e[31mFAIL\e[0m]   [\e[1;31m${Component}\e[0m] [\e[1;31m$(date "+%F %T")\e[0m] \e[1;31m $1  failed \e[0m"
}
#mkdir robolog
#cd robolog
#touch robo.log
